                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="panel panel-white">
                                ...
                                <table class="table">
                                    <form action="<?php echo base_url();?>index.php/profile/updateProfile" method="POST">
                                        <tbody>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <form action="<?php echo base_url();?>index.php/profile/updatePicture" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <form action="<?php echo base_url();?>index.php/profile/new_password" method="POST">
                                        <div class="form-group">
