                                        ...
                                        <tbody>';
                                                        ...
                                                        foreach ($result as $row) {
                                                            ...
                                                            if ($status == "1") {
                                                                ...
                                                                $stl = '<a href="http://otee.ir/teacher/index.php/exam/inactive_crs/'.$row->course_id.'">Make Inactive</a>';
                                                            }else{
                                                                $st = '<p class="text-danger">INACTIVE</p>';
                                                                $stl = '<a href="http://otee.ir/teacher/index.php/exam/active_crs/'.$row->course_id.'">Make Active</a>';
                                                            }
                                                            print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row->course_name; ?> ?')" <?php print ' href="http://otee.ir/teacher/index.php/exam/drop_course/'.$row->course_code.'">Drop course</a></li>
                                                </ul>
                                            </div></td>
...
<!--                                                    </div>-->
                                        ...
                                        <tbody>';
                                                        ...
                                                        foreach ($result as $row) {
                                                            ...
                                                            if ($status == "1") {
                                                                $st = '<p class="text-success">ACTIVE</p>';
                                                                $stl = '<a href="http://otee.ir/teacher/index.php/exam/inactive_ex/'.$row->exam_id.'">Make Inactive</a>';
                                                            }else{
                                                                $st = '<p class="text-danger">INACTIVE</p>';
                                                                $stl = '<a href="http://otee.ir/teacher/index.php/exam/active_ex/'.$row->exam_id.'">Make Active</a>';
                                                            }
                                                            print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
													<li><a href="http://otee.ir/teacher/index.php/exam/edit_exam/'.$row->exam_id.'">Edit Exam</a></li>
													<li><a href="http://otee.ir/teacher/index.php/question/view_question/'.$row->exam_id.'">View Questions</a></li>
													<li><a href="http://otee.ir/teacher/index.php/exam/question/'.$row->exam_id.'">Add Questions</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row->exam_title; ?> ?')" <?php print ' href="http://otee.ir/teacher/index.php/exam/drop_exam/'.$row->exam_id.'">Drop Exam</a></li>
                                                </ul>
                                            </div></td>
