                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        if ($type == "FB") {
											...
											<div role="tabpanel" class="tab-pane active fade in" id="tab'.$qno.'">
											 ...
											 <hr>
											 <a  class="btn btn-twitter m-b-xs"href="edit-question.php?id='.$row->question_id.'"><i class="fa fa-pencil"></i></a>
											 <a';?> onclick = "return confirm('Drop this question ?')" <?php print 'class="btn btn-youtube m-b-xs"href="http://localhost/iQuiz/admin/index.php/question/drop_question/'.$row->question_id.'"><i class="fa fa-trash-o"></i></a>
                                             </div>
											';
                                            }else{
                                                print '
